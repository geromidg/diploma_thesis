...
resampling problem depending on the situtation, we make use of a fairly
...
the local one.
Furthermore, in contast to the local map which is always centered around
...
Although the aforementioned matching technique can provide accurate
results, it highly depends on the terrain the robot is navigating in.
The reason is that ...
