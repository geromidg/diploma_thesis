...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.7]{high_level_design_diagram}
...
\begin{enumerate}
    ...
    \item \textbf{Cropping}:
        ...
        x and y axis,
        $t_x$ and $t_y$ represent the translation of the map in meters in the
        x and y axis of the global coordinate system and
    ...
    \item \label{map_update} \textbf{Update} \\
        ...
        \begin{figure}[t]
            ...
            \begin{subfigure}{0.5\textwidth}
                \centering
                \includegraphics[scale=0.2]{point_cloud}
                \caption{Point cloud to be registered}
                \label{fig:point_cloud}
            \end{subfigure}
            \begin{subfigure}{0.5\textwidth}
                \centering
                \includegraphics[scale=0.4]{local_elevation_map}
...
sensor and obtain these states directly from it, so the problem state becomes
\begin{equation}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.7]{pose_estimation_activity_diagram}
...
an \text{Iterative Closest Point} (ICP) variant \parencite{Zhang1994}.
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.25]{local_and_global_maps}
...
\begin{itemize}
    \item \textbf{Preprocessing} \\
        ...
        \begin{figure}[t]
            ...
            \begin{subfigure}{0.5\textwidth}
                \centering
                \includegraphics[scale=0.25]{elevation_image}
                \caption{Raw elevation image}
                \label{fig:elevation_image}
            \end{subfigure}%
            \begin{subfigure}{0.5\textwidth}
                \centering
                \includegraphics[scale=0.25]{gradient_image}
    ...
    \item \textbf{Matching} \\
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[scale=0.4]{template_matching_result_matrix}
