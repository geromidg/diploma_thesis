...
% TODO: add figures of the rover / sensor setup
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{high_level_design_diagram}
    % \includegraphics[scale=0.4]{system_component_diagram}
    \decoRule
...
% TODO: add figures from NASA's HiRISE depicting actual Mars point clouds
